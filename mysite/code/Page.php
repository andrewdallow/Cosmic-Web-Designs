...
class Page_Controller extends ContentController {
    ...
    public function init() {
        ...
        Requirements::css("https://fonts.googleapis.com/css?family=Orbitron&subset=latin");
        ...
        $JSFiles = array(
            $themeFolder . "/javascript/businessApp.js",
            $themeFolder . "/javascript/footerController.js",
            $themeFolder . "/javascript/contactFormController.js",
            $themeFolder . "/javascript/projectFormController.js"
        );  
